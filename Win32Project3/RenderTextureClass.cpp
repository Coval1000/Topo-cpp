...
void RenderTextureClass::ToBitmap(ID3D11DeviceContext* deviceContext)
{
	D3D11_MAPPED_SUBRESOURCE mappedResource;
	deviceContext->Map(_renderTargetTexture, 0, D3D11_MAP_WRITE, 0, &mappedResource);

	deviceContext->Unmap(_renderTargetTexture, 0);
}